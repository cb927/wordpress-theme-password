...
function mailer_config($mail)
{
	$mail->isSMTP();
	//Set SMTP host name                          
	$mail->Host = "mail71.onamae.ne.jp";
	//Set this to true if SMTP host requires authentication to send email
	$mail->SMTPAuth = true;
	//Provide username and password     
	$mail->Username = "info@password-inc.site";
	$mail->Password = "Cham5964!";
...
add_action('add_meta_boxes', 'multi_media_uploader_meta_box_liver');

function multi_media_uploader_meta_box()
{
	add_meta_box('my-post-box', 'Media Field', 'multi_media_uploader_meta_box_func', 'model', 'normal', 'high');
}

function multi_media_uploader_meta_box_liver()
{
	add_meta_box('my-post-box', 'Media Field', 'multi_media_uploader_meta_box_func', 'liver', 'normal', 'high');
}
